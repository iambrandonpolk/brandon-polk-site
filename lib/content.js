...
//
// Two kinds of items: a plain link ({ label, href }) or a group with a
// dropdown ({ label, children: [...] }). "The Margins" gathers the written,
// reflective work; "Resources" is a hub page for books, podcast, and gear.
export const nav = [
  ...
  { label: "A Better Question", href: "/a-better-question" },
  {
    label: "The Margins",
    children: [
      { label: "Writing", href: "/writing", desc: "The podcast, written down." },
      { label: "Diaries", href: "/diaries", desc: "Self Growth Diaries." },
      { label: "Perspective", href: "/perspective", desc: "What readers are noticing." },
    ],
  },
...
// Trading room, run through Patreon (which grants the Discord role on join).
// Swap in the real Patreon URL once the page is created, and the site picks
// it up everywhere the Join button appears.
export const patreon = {
  url: "https://www.patreon.com/iambrandonpolk",
};
...
// The three-book strip at the top of /bookshelf: what Brandon is on right now.
// "label" is the state, not a category. Edit these three as they change.
export const readingNow = [
  { label: "Nearly finished", title: "Start with No", author: "Jim Camp", href: "https://www.amazon.com/dp/0609608002?tag=iambrandonpol-20", img: "https://m.media-amazon.com/images/I/619-8kvN2cL._SS284_.jpg" },
  { label: "Partway through", title: "Show Your Work!", author: "Austin Kleon", href: "https://www.amazon.com/dp/076117897X?tag=iambrandonpol-20", img: "https://m.media-amazon.com/images/I/71MTgEEjNVL._SS284_.jpg" },
  { label: "Up next", title: "Captivate", author: "Vanessa Van Edwards", href: "https://www.amazon.com/dp/0399564497?tag=iambrandonpol-20", img: "https://m.media-amazon.com/images/I/81Ksx9YwqTL._SS284_.jpg" },
];
...
export const bookshelf = [
  ...
  },
  {
    ...
    books: [
      ...
      { title: "Start with No", blurb: "Jim Camp's counter to win-win: let the other side feel free to say no, and the pressure that blocks real decisions falls away.", href: "https://www.amazon.com/dp/0609608002?tag=iambrandonpol-20", img: "https://m.media-amazon.com/images/I/619-8kvN2cL._SS284_.jpg" },
...
// ------------------------------------------------------------------
// Writing: essays live in the Notion "Writing" database and publish from
// there (Draft -> Published), exactly like the diaries. This fallback is
// intentionally EMPTY so a draft never leaks onto the site before you hit
// Publish. The site reads essays straight from Notion.
// ------------------------------------------------------------------
